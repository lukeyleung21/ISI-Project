<template>
    <v-simple-table v-if="this.$store.getters.userType == '0'" height="300px"><template v-slot:default><thead><tr>
    ...
    <v-simple-table v-else height="300px"><template v-slot:default><thead><tr>
        <th class="text-left">Full Name</th>
